...
public class GtpAccountsApplication {
    ...
    public CommandLineRunner commandLineRunner(UserRepository userRepository, CountryRepository countryRepository,
        ...
        return args -> {
            ...
            organizationDto = organizationMapper.convertOrganizationToDto(organizationDb);
            ...
            AppIdDto groupDevAppDto1 = new AppIdDto(ApplicationConstants.DEV_KEY_1, ApplicationConstants.DEV_KEY_1, "Group Dev App Id");

            AppIdDto groupDevAppDto2 = new AppIdDto(DEV_KEY_2, DEV_KEY_2, "Group Dev App Id 2");

            AppIdDto groupQaAppDto1 = new AppIdDto(QA_KEY_1, QA_KEY_1, "Group QA App Id");
            AppIdDto groupQaAppDto2 = new AppIdDto(QA_KEY_2, QA_KEY_2, "Group QA App Id 2");
            ...
            CreateEnvironmentDto environmentDto =  createEnvDto(organizationDto, "DEV", DEV_URL,
            ...
            CreateEnvironmentDto environmentDto2 =  createEnvDto(organizationDto, "QA", QA_URL,
    ...
    private static CreateEnvironmentDto createEnvDto(OrganizationDto organizationDto, String environmentName, String gatewayURL, String tokenURL, List<AppIdDto> appIds, String defaultConfig) {
